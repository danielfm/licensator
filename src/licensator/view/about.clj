  ...
  (layout
   ...
   :banner {:img (str *img-prefix* "devil.png")
            ...
            :content [:div
                      ...
                      [:p "As you can see, things can get ugly. That's why I wrote this app."]]}
   :content [:div
             [:h2 "Who?"]
             [:p (menu :home "Licensator") " is developed by " (elink-to *author-url* *author-name*) "."]
             [:h2 "Tech?"]
             [:p (menu :home "Licensator") " is written in " (elink-to "http://clojure.org" "Clojure") ", a dynamic programming language that targets the " (elink-to "http://java.com" "Java VM") ". I also used " (elink-to "http://github.com/weavejester/compojure" "Compojure") ", " (elink-to "http://github.com/weavejester/hiccup" "Hiccup") ", " (elink-to "http://github.com/technomancy/leiningen" "Leiningen") ", " (elink-to "http://html5boilerplate.com" "HTML5 Boilerplate") ", and " (elink-to "http://tango.freedesktop.org" "Tango Desktop Project") ". No database, baby!"]
